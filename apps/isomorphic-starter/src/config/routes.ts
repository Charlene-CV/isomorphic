export const routes = {
  ...
  editTariff: (id: string) => `/tariffs/${id}/edit`,
  ...
  equipment: '/profile/management/equipment',
  accessorials: '/profile/management/accessorials',
  services: '/profile/management/services',
  accounting: '/accounting',
  taxes: '/profile/accounting/taxes',
  paymentTerms: '/profile/accounting/paymentTerms',
  welcome: '/welcome',
