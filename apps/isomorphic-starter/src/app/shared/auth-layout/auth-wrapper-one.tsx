...
export default function AuthWrapperOne({
  ...
  return (
    <>
      ...
      >
        <PiArrowLeftBold />
        <Text className="ms-1 font-lexend" style={{color: "#a5a234"}}>Back to home</Text>
      </Link>

      <div className="min-h-screen justify-between gap-x-8 px-4 py-8 pt-10 md:pt-12 lg:flex lg:justify-center lg:p-6 xl:gap-x-10 xl:p-7 2xl:p-10 2xl:pt-10 [&>div]:min-h-[calc(100vh-80px)]">
        <div className="relative flex w-full align-center items-center justify-center lg:w-5/12 2xl:justify-end 2xl:pe-24">
              ...
              <>
                <div className="flex flex-col pb-5">
                  ...
                  <Button
                    ...
                    className="h-11 text-center w-80 self-center"
